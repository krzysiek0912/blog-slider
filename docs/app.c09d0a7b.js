...
(0, _tinySlider.tns)(Object.assign({
  container: '.new-furniture-slider-bed'
}, option));
(0, _tinySlider.tns)(Object.assign({
  container: '.new-furniture-slider'
}, option)); // Section Brand Slider

var brandsSlider = (0, _tinySlider.tns)({
...
document.querySelector('.brands-slider .btn-prev').addEventListener('click', function () {
  return brandsSlider.goTo('prev');
});
document.querySelector('.brands-slider .btn-next').addEventListener('click', function () {
  return brandsSlider.goTo('next');
}); // Section Blog Slider
// eslint-disable-next-line no-unused-vars

var blogSlider = (0, _tinySlider.tns)({
...
var tabs = document.querySelectorAll('#nav-tab li > a');
...
function tabClick(event) {
  ...
  for (var _i = 0; _i < contentPanes.length; _i++) {
    contentPanes[_i].classList.remove('active');
  }
